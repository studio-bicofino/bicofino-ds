...
```bash
INIT=$(node "/Users/woneymalian/Desktop/SITE BICOFINO/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/woneymalian/Desktop/SITE BICOFINO/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
