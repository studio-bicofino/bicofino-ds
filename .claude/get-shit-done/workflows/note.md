...
- **Global scope**: `/Users/woneymalian/Desktop/SITE BICOFINO/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/woneymalian/Desktop/SITE BICOFINO/.claude/notes/`)
...
2. Glob `/Users/woneymalian/Desktop/SITE BICOFINO/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/woneymalian/Desktop/SITE BICOFINO/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/woneymalian/Desktop/SITE BICOFINO/.claude/notes/` — works in any directory
