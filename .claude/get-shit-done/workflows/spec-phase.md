...
```bash
INIT=$(node "/Users/woneymalian/Desktop/SITE BICOFINO/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/woneymalian/Desktop/SITE BICOFINO/.claude/get-shit-done/templates/spec.md.
