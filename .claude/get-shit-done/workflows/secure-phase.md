...
```
Agent(
  prompt="Read /Users/woneymalian/Desktop/SITE BICOFINO/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/woneymalian/Desktop/SITE BICOFINO/.claude/get-shit-done/templates/SECURITY.md`
