...
export const metadata: Metadata = {
  title: 'Mercados Globais — Vanguarda × Bicofino',
  description:
    'Cruzamento do mapa global de mercados 2026 com a lente Bicofino. Cinco ângulos, descartes explícitos, Método Quarteto.',
        ...
        >
          ...
          >
            <div className="mono" style={{ fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase' }}>
              Documento interno · 2026-05-25
            </div>
            <div style={{ fontSize: 13 }}>
              Audiência restrita · Membros Club Bicofino
            </div>
          </div>
        </footer>
      </body>
