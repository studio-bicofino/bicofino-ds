...
export const ATHLETES: Athlete[] = [
  ...
  { slug: 'gabriel-rigorfi', name: 'Gabriel Rigorfi', firstName: 'Gabriel', driveFolder: 'GABRIEL RIGORFI' },
  ...
  { slug: 'lucas-ovies', name: 'Lucas Ovies', firstName: 'Lucas', driveFolder: 'LUCAS OVIES' },
