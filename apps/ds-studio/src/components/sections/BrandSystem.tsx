...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
export function BrandSystemCover() {
  const { lang } = useLang()
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
export function BrandFundamentos() {
  const { lang } = useLang()
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════ */
export function BrandPosicionamento() {
  const { lang } = useLang()
      ...
      <div style={{ borderTop: hairline }}>
        ...
        <AccordionItem title={c.personas.a.title}>
          {c.personas.a.rows.map(([label, text]) => (
            <div key={label} style={{ display: 'grid', gridTemplateColumns: 'minmax(120px, 200px) 1fr', padding: '14px 0', borderBottom: hairline, gap: 32, alignItems: 'start' }}>
        ...
        <AccordionItem title={c.personas.b.title}>
          <div style={{ padding: '14px 0', borderBottom: hairline, display: 'grid', gridTemplateColumns: 'minmax(120px, 200px) 1fr', gap: 32, alignItems: 'start' }}>
      ...
      <div style={{ borderTop: hairline }}>
        ...
        <div style={{ padding: `0 ${H_PAD} 56px` }}>
          ...
          {c.craft.items.map(([label, text]) => (
            <div key={label} style={{ display: 'grid', gridTemplateColumns: 'minmax(140px, 240px) 1fr', padding: '18px 0', borderBottom: hairline, gap: 32, alignItems: 'start' }}>
      ...
      <div style={{ borderTop: hairline }}>
        ...
        <AccordionItem title={c.vocabulario.bicofinoWords.title}>
          {c.vocabulario.bicofinoWords.items.map(([term, def]) => (
            <div key={term} style={{ display: 'grid', gridTemplateColumns: 'minmax(100px, 160px) 1fr', padding: '14px 0', borderBottom: hairline, gap: 32, alignItems: 'start' }}>
